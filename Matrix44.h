        ...
        double neueDaten[16] =
            {
                ...
                *(neueDaten + 2) = *(daten)*m.get(0, 2) + *(daten + 1) * m.get(1, 2) + *(daten + 2)*m.get(2, 2) + *(daten + 3) * m.get(3, 2),
                *(neueDaten + 3) = *(daten)*m.get(0, 3) + *(daten + 1) * m.get(1, 3) + *(daten + 2)*m.get(2, 3) + *(daten + 3) * m.get(3, 3),
