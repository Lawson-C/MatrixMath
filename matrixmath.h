...
template <int Zeilen>
Vector2 operator*(Vector2 &v, Matrix<Zeilen, 2> &m)
{
...
template <int Zeilen>
Vector3 operator*(Vector3 &v, Matrix<Zeilen, 3> &m)
{
    double neueDaten[Zeilen];
    for (int i = 0; i < Zeilen; i++)
    {
...
template <int Zeilen>
Vector4 operator*(Vector4 &v, Matrix<Zeilen, 4> &m)
{
    double neueDaten[Zeilen];
    for (int i = 0; i < Zeilen; i++)
    {
